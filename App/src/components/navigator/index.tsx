  ...
  return (
    ...
    >
      ...
      <div className={styles.nav_middle}>
        ...
        <Link 
          href="/community"
          className={`${styles.nav_link} ${isActive("/community") ? styles.active : ""}`}
          style={{
        ...
        <Link 
          href="/about"
          className={`${styles.nav_link} ${isActive("/about") ? styles.active : ""}`}
          style={{
      ...
      <div className={styles.nav_right}>
        <Link 
          href="/signin"
          className={`${styles.nav_link} ${styles.signin_button}`}
          style={{
            color: isActive("/signin") ? theme.backgroundColor : theme.primaryColor,
            backgroundColor: isActive("/signin") ? theme.primaryColor : "transparent",
